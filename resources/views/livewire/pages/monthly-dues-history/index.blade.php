...
<div>
    ...
    <div class="row">
        <div class="col-md-12">
            <livewire:pages.monthly-dues-history.list />
        </div>
    </div>

    @push('modals')
        <div class="modal modal-fullscreen px-0 fade" id="modal-dues-history" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered shadow-none" role="document">
                <div class="modal-content overflow-hidden">
                    <livewire:pages.monthly-dues-history.modal-content />
                </div>
            </div>
        </div>
    @endpush
...
@script
    <script>
        $(function () {
            $("#modal-dues-history").on("hidden.bs.modal", function (e) {
                window.dispatchEvent(new CustomEvent('fetchModalDuesHistoryContentJs'));
            });
        });
    </script>
@endscript
