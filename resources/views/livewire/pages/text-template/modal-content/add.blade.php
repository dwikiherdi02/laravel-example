...
<div>
    <div class="modal-header bg-transparent border-0">
        <h5 class="modal-title" id="modal-resident-title">{{ __('Tambah Template') }}</h5>
        ...
        <form wire:submit="createTextTemplate" id="user-form">
            <div class="row">
                <div class="form-group col-12 col-md-12 mb-3">
                    <x-input-label for="name" :value="__('Nama Template')" :isRequired="true" />
                ...
                <div class="form-group col-12 col-md-12 mb-3">
                    <x-input-label for="email_subject" :value="__('Subjek Email')" :isRequired="true" />
